...
@Configuration
@ComponentScan("com") //scan all the classes in order to connect to the DB  and perform the transactions
@EnableTransactionManagement
public class hibernateConfig{

	@Autowired
	@Bean(name="dataSource")//@Bean is used to mention or give or determine the behavior of the POJO class with a particular bean name
	public DataSource getH2DataSource()
	{
		System.out.println("Data Source Method");
		DriverManagerDataSource dataSource = new DriverManagerDataSource();
		dataSource.setDriverClassName("org.h2.Driver");
		dataSource.setUrl("jdbc:h2:tcp://localhost/~/test");  //always go to Generic h2 server (tcp)
	...
	private Properties getHibernateProperties() {
		...
		return properties;
         ...
         //HIBERNATE object is created by sessionFactory
	@Autowired    
